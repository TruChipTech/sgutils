 ...
 * Date: 2026-05-07
 *
 * sgfb-text.c - Render text to the framebuffer using FreeType fonts
 *
...
static void print_help(const char *prog) {
    printf("Usage: %s -t TEXT -F FONT [OPTIONS]\n\n"
           "Render text onto the Linux framebuffer using a TrueType font.\n\n"
           "Required:\n"
...
int main(int argc, char *argv[]) {
    ...
    int font_size   = 32;
    int pos_x       = 0;
    int pos_y       = -1; /* -1 means "use font_size as default" */
    ...
    while ((opt = getopt_long(argc, argv, "t:F:d:s:x:y:c:b:hv",
        ...
        switch (opt) {
            ...
            case 'v': printf("sgfb-text " VERSION "\n"); return 0;
...
#include <stdio.h>
int main(void) {
    fprintf(stderr, "sgfb-text: FreeType support not compiled. "
